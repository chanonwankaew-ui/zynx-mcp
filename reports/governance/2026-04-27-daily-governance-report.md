...
- Run ID: governance-20260427-1777258358863
- Timestamp (local): 2026-04-27 09:52:38 Asia/Bangkok
...
```md
- 2026-04-27: Generated first-pass nightly governance report. State=PartialCompletion. No destructive action taken.
```

## daily-governance-log.md (append block)
```md
- 2026-04-27: Ran Nightly Governance Validation. Output=reports/governance/2026-04-27-daily-governance-report.md.
```
